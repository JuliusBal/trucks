...
@section('content')
    ...
    <form method="POST" action="{{ route('trucks.update', ['truck' => $truck]) }}" class="w-full max-w-lg mt-16">
        ...
        <div class="col-span-3 mt-16" style="display:flex;justify-content:space-between">
            ...
            <button type="submit" class="color-red">Save</button>
        </div>
    </form>
@endsection
